...
% We note that from within Numba functions, memory is managed by the Numba runtime [NRT], a library for allocating and freeing memory written in C. The NRT is also responsible for safely boxing primitive types into Python objects when it returns control to the interpreter.
