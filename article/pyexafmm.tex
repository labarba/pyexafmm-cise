...
\begin{table*}
	\centering
	\caption{Number of particles $N=$1,000,000 leading to $M$ leaves in a given geometry. $k$ is the compression rank for PyExaFMM. Charge densities are chosen in the interval $[0, 1)$. Runtimes exclude tree building time. Memory usage and relative error reported to 3 s.f.}
	\begin{tabular}{|*{10}{c|}}
		\hline
		...
		\hline
		10 & 17,017 & 6 &   Sphere  &  $14.0 \pm 0.2$ s & $0.97 \pm 0.03$ s  &  6.21 GB  &   5.25 GB  & 1.00e-4 & 8.75e-5\\
		 & 32,768 &    &   Random  &  $17.7 \pm 0.5$ s &  $1.23 \pm 0.05$ s &  8.20 GB  &   5.34 GB  & 8.75e-5 & 7.66e-5\\
		100 & 17,017 &    &   Sphere  &  $13.9 \pm 0.2$ s &   &  6.21 GB  &   & 1.00e-4 & 8.75e-5\\
		 & 32,768 &    &   Random  &  $22.8 \pm 0.2$ s &  &  8.20 GB  &  & 8.75e-5 & 7.66e-5\\
		Full Rank & 17,017 &   &   Sphere  &  $16.2 \pm 0.1$ s &   &  6.27 GB  &    & 1.00e-4 & 8.75e-5\\
		 & 32,768 &    &   Random  &  $54 \pm 3$ s &   &  8.20 GB  &  & 8.75e-5 & 7.66e-5\\
		\hline
	\end{tabular}
