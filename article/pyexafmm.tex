...
\lstinputlisting[caption={Three ways of writing an algorithm performs that some computations and saves the results to a dictionary.}\label{code:nested_function}]{nested_function.py}
