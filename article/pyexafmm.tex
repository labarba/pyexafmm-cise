...
\begin{table}
	\centering
	\caption{Effect of compression rank $k$, with multipole and local expansions of order $p=5$, corresponding to $n=98$ quadrature points, for FMM problem with 100,000 randomly distributed points. Point coordinates and charge densities chosen in the interval [0, 1). Runtimes repeated seven times for statistics, peak memory consumption and accuracy reported to 3 significant figures.}
