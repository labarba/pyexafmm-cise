...
\begin{figure}
	...
	\caption{Fractional runtimes broken down by operator for (a) ExaFMM-T $p=4$ (b) ExaFMM-T $p=6$ (c) PyExaFMM $p=4$, $k=50$ (d) PyExaFMM $p=6$, $k=50$ (e) PyExaFMM $p=6$, $k=150$}
...
\begin{table*}
	...
	\begin{tabular*}{0.934\textwidth}{|*{10}{c|}}
		...
		% \hdashline
		% %  & &    &  & &   &  &  & & \\
		% 10 & 17,017 & 10 &   Sphere  &  $14.0 \pm 0.2$ s & $1.77 \pm 0.2$ s  &  2.64 GB  &  1.96 GB  & 4.64e-4 & 3.82e-7 \\
		%  & 32,768 &    &   Random  &  $17.7 \pm 0.5$ s &  $2.43 \pm 0.02$ s &  4.66 GB  &  2.04 GB  & 1.46e-4 &  3.31e-7\\
		%  & & 100   &   Sphere  &  $13.9 \pm 0.2$ s &   &  2.66 GB  &   & 4.58e-7 &  \\
		%  & &    &   Random  &  $22.8 \pm 0.2$ s &  &  4.68 GB  &  & 3.46e-6 & \\
		%  & & Full Rank  &   Sphere  &  $16.2 \pm 0.1$ s &   &  2.70 GB  &  & 4.61e-7 & \\
		%  & & (488) &   Random  &  $54 \pm 3$ s &   &  4.72 GB  &  & 3.94e-7 & \\
