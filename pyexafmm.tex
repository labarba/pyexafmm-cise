...
\title{PyExaFMM: A case study in designing high performance software in Python}
...
SK is supported by Engineering and Physical Sciences Resesarch Council (EPSRC) studentship 2417009.
...
\begin{IEEEbiography}{Srinath Kailasa}{\,} is a graduate student at University College London. He is currently pursuing a PhD in Applied and Computational Mathematics, having received an MPhys (2017) and MSc  (2020) from the University of Durham, and University College London respectively. His research interests are in high-performance computing, specifically in the application of software engineering methods, and parallel and heterogenous computing, to problems in computational electromagnetics. Contact him at srinath.kailasa.18@ucl.ac.uk.
\end{IEEEbiography}
